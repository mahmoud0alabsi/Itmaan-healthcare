...
class SettingsPage extends StatelessWidget {
  final Users staff;
  const SettingsPage({super.key, required this.staff});
            ...
            child: Column(
              ...
              children: [
                ...
                const Padding(
                  ...
                  child: Text(
                    'هل أنت متأكد أنك تريد حذف جميع المرضى؟',
                ...
                Row(
                  ...
                  children: [
                    ...
                    CircleIconButton(
                      ...
                      onTap: () {
                        Navigator.of(context).pop();
                        _deleteAllPatients(); // اتصال بدالة الحذف
                      },
                    ),
                  ],
                ),
  ...
  Future<void> _deleteAllPatients() async {
    ...
    AllStatusConversations.clear();
    AllConversationsChats.clear();
  
    all_patient_users_count = 0;
    all_status_conversations_count = 0;
    all_conversations_chats_count = 0;

    await UserManager.saveUsers();
    await StatusConvManager.saveStatusConversations();
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      Text(
                        "الاسم : ${staff.f_name} ${staff.l_name}",
                  ...
                  const SizedBox(height: 7),
                  Text(
                    "المستشفى : ${staff.hospital}",
                    style: const TextStyle(color: Colors.white, fontSize: 16.0),
                  ),
                  const SizedBox(height: 7),
                  Text(
                    "القسم : ${staff.department}",
                    style: const TextStyle(color: Colors.white, fontSize: 16.0),
                  ),
